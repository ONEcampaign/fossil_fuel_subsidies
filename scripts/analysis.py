...
CF = pd.read_csv(Paths.output / "climate_finance_commitments.csv") # climate finance data
FFS = pd.read_csv(Paths.output / "fossil_fuel_subsidies.csv") # fossil fuel subsidies data
